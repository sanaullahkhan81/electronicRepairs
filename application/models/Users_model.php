...
Thank you for your Visit
  ...
  `engineer_code` varchar(15) COLLATE utf8_unicode_ci DEFAULT '',
  `engineer_status` int(11) NOT NULL DEFAULT '0',
  `engineer_comments` longtext COLLATE utf8_unicode_ci DEFAULT '',
  `signature_image` varchar(150) COLLATE utf8_unicode_ci DEFAULT '',
  `signature_image_collected` varchar(150) COLLATE utf8_unicode_ci DEFAULT '',
